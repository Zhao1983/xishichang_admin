                    ...
                    <el-col :span="24">
                        <el-col :span="8">
                            ...
                            <el-form-item prop="shopName" label-width="15%" label="商户名称: " class="postInfo-container-item">
                                <el-input id="shopName" ref="shopName" v-model="dataForm.shopName" size="small" placeholder="商户名称" style="width: 60%;" />
                        ...
                        <el-col :span="8">
                            ...
                            <el-form-item prop="floorNum" label-width="10%" label="位置信息: " class="postInfo-container-item">
                                <!-- 점포 층수 -->
                                <el-select ref="floorNum" v-model="dataForm.floorNum" size="small" placeholder="楼层" clearable style="width: 25%;" @change="setChangeFloor">
                                    <el-option key="" value="" />
                                    <el-option v-for="item in listFloor" :key="item" :label="item" :value="item" />
                                </el-select>
                                <!-- 점포 구역 -->
                                <el-select ref="zoneNum" v-model="dataForm.zoneNum" size="small" placeholder="区" clearable style="width: 25%; margin-left: 10px;" @change="setChangeZone">
                                    <el-option key="" value="" />
                                    <el-option v-for="item in listZone" :key="item" :label="item" :value="item" />
                                </el-select>
                                <!-- 점포 위치 -->
                                <el-select ref="positionNum" v-model="dataForm.positionNum" size="small" placeholder="位号" clearable style="width: 25%; margin-left: 10px;">
                                    <el-option key="" value="" />
                        ...
                        <el-col :span="8">
                            ...
                            <el-form-item label-width="15%" label="商户位置备注: " class="postInfo-container-item">
                                <el-input id="locationRemark" ref="locationRemark" size="small" v-model="dataForm.locationRemark" placeholder="商户位置备注" style="width: 60%;" />
                    ...
                    <el-col :span="24">
                        <el-col :span="8">
                            ...
                            <el-form-item prop="rankingNum" label-width="15%" label="序号: " class="postInfo-container-item">
                                <el-input id="rankingNum" ref="rankingNum" size="small" v-model="dataForm.rankingNum" placeholder="序号" style="width: 60%;" />
                    ...
                    <el-col :span="24">
                        <el-col :span="8">
                            ...
                            <el-form-item label-width="15%" label="开店时间: " class="postInfo-container-item">
                                <el-date-picker type="date" id="openDt" ref="openDt" size="small" v-model="dataForm.openDt" placeholder="开店时间" style="width: 60%;" />
...
<script src="@/assets/js/shop/shop_register.js"></script>
