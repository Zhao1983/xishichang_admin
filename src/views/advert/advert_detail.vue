    ...
    <el-dialog v-el-drag-dialog title="广告商品" :visible.sync="isShowProductDlg" :close-on-click-modal="false">
        <div class="filter-container" style="margin-bottom: 15px;">
            <el-row>
                ...
                <el-button type="default" size="small" icon="el-icon-search" style="float: right;" @click="setSearchProduct">搜索</el-button>
            </el-row>
        </div>
        <el-row>
            <el-card class="box-card">
                <el-table v-loading="listLoading" :data="listProduct" border fit highlight-current-row style="width: 100%;">
                    <el-table-column label="选择" prop="id" align="center" width="80%;">
                        <template slot-scope="{row}">
                            <input type="radio" v-model="row.checked" name="" :value="row.id" @click="setSelectProduct(row)">
                        </template>
                    </el-table-column>
        ...
        <el-row>
            <el-card class="box-card">
                <el-table v-loading="listLoading" :data="listShop" border fit highlight-current-row style="width: 100%;">
                    <el-table-column label="选择" prop="id" align="center" width="80%;">
                        <template slot-scope="{row}">
                            <input type="radio" v-model="row.checked" name="" :value="row.id" @click="setSelectShop(row)">
                        </template>
                    </el-table-column>
        ...
        <el-row>
            <el-card class="box-card">
                <el-table v-loading="listLoading" :data="listTopic" border fit highlight-current-row style="width: 100%;">
                    <el-table-column label="选择" prop="id" align="center" width="80%;">
                        <template slot-scope="{row}">
                            <input type="radio" v-model="row.checked" name="" :value="row.id" @click="setSelectTopic(row)">
                        </template>
                    </el-table-column>
...
<script src="@/assets/js/advert/advert_detail.js"></script>
