                ...
                <el-row>
                    <el-col :span="24">
                        ...
                        <el-form-item prop="topicName" label-width="15%" label="专题名称: " class="postInfo-container-item">
                            <el-input id="topicName" ref="topicName" size="small" v-model="dataForm.topicName" placeholder="请输入专题名称" style="width: 36%;" />
                        ...
                        <el-form-item label-width="15%" label="副题名称: " class="postInfo-container-item">
                            <el-input id="topicAlias" ref="topicAlias" size="small" v-model="dataForm.topicAlias" placeholder="请输入副题名称" style="width: 36%;" />
                        ...
                        <el-form-item prop="rankingNum" label-width="15%" label="序号: " class="postInfo-container-item">
                            <el-input id="rankingNum" ref="rankingNum" size="small" v-model="dataForm.rankingNum" placeholder="请输入序号" style="width: 36%;" />
                        ...
                        <el-form-item prop="topicType" label-width="15%" label="专题分类: " class="postInfo-container-item">
                            <el-select ref="topicType" v-model="dataForm.topicType" size="small" placeholder="专题分类" clearable style="width: 36%;" @change="setChangeTopicType">
                        ...
                        <el-form-item v-show="dataForm.topicType === '1'" prop="entityId" label-width="15%" label="所属分类: " class="postInfo-container-item">
                            <el-input id="entityName" ref="entityName" size="small" v-model="dataForm.entityName" placeholder="请输入所属分类" style="width: 30.2%;" :readonly="true" />
...
<script src="@/assets/js/topic/topic_detail.js"></script>
