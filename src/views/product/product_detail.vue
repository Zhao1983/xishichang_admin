                    ...
                    <el-col :span="24">
                        <el-col :span="8">
                            ...
                            <el-form-item prop="shopName" label-width="15%" label="所属商户: " class="postInfo-container-item">
                                <el-input id="shopName" ref="shopName" v-model="dataForm.shopName" size="small" placeholder="请输入所属商户" style="width: 48.5%;" :readonly="true" />
            ...
            <el-card class="box-card" style="margin-bottom: 10px;">
                <el-row>
                    ...
                    <el-col :span="4">
                        <el-form-item prop="salesPrice" label-width="30%" label="销售价: " class="postInfo-container-item">
                            <el-popover placement="top-start" title="" width="170" trigger="manual" content="注意销售价低于进价" v-model="isVisiblePriceToolTip">
                                <el-input slot="reference" v-if="dataForm.isPercent" class="color_prop" id="salesPrice" ref="salesPrice" size="small" type="text" v-model="dataForm.salesPrice" placeholder="销售价" :readonly="true" />
                                <el-input slot="reference" v-else class="color_prop" id="salesPrice" ref="salesPrice" type="text" size="small" v-model="dataForm.salesPrice" placeholder="销售价" />
                            </el-popover>
                        </el-form-item>
                        <el-col :span="7">
                    ...
                    <el-col :span="4">
                        ...
                        <el-form-item prop="profitRate" label-width="30%" label="商品利润率: " class="postInfo-container-item">
                            <el-input id="profitRate" ref="profitRate" size="small" type="text" v-model="dataForm.profitRate" placeholder="商品利润率" :readonly="true" />
                        </el-form-item>
                    </el-col>
                    <!-- 가상판매량 -->
                    <el-col :span="4">
                    ...
                    <el-col :span="24">
                        <el-table :data="dataOption" border fit highlight-current-row style="width: 100%;" v-show="isOption === 1">
                            ...
                            <el-table-column label="销售价" align="center" width="125%;">
                                <template slot-scope="{row, $index}">
                                    <el-popover placement="bottom-start" title="" width="170" trigger="manual" content="注意销售价低于进价" v-model="row.isVisiblePriceToolTip">
                                        <el-input slot="reference" v-if="row.isPercent" class="color_prop" :id="'salesPrice-' + $index" v-model="row.salesPrice" type="text" size="small" :ref="'salesPrice-' + $index" placeholder="" :readonly="true" />
                                        <el-input slot="reference" v-else class="color_prop" :id="'salesPrice-' + $index" v-model="row.salesPrice" type="text" size="small" :ref="'salesPrice-' + $index" placeholder="" />
                                    </el-popover>
                                </template>
                            </el-table-column>
