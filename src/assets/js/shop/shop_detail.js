...
export default {
    ...
    created() {
        ...
        this.shopId = this.$route.params && this.$route.params.id // 해당 점포 아이디
    ...
    data() {
        return {
            ...
            dataForm: {
                ...
                shopWechatId: undefined, // 점포운영자위챗아이디
    ...
    methods: {
        ...
        getShopData() {
            getShopDetail(this.shopId).then(response => {
                if (response.code === 0) {
                    this.dataForm.shopName = response.data.shopName
                    this.dataForm.shopOwner = response.data.shopOwner
                    this.dataForm.phoneNum = response.data.phoneNum
                    this.dataForm.idCard = response.data.idCard
                    this.dataForm.rankingNum = response.data.rankingNum
                    this.dataForm.shopWechatId = response.data.shopWechatId
                    this.dataForm.shopWechatName = response.data.shopWechatName
                    this.dataForm.typeId = response.data.typeId
                    this.dataForm.subTypeId = response.data.subTypeId
                    this.dataForm.typeName = response.data.subTypeName
                    this.tempTypeId = response.data.typeId
                    this.tempSubTypeId = response.data.subTypeId
                    this.dataForm.isSelf = response.data.isSelf === '1'
                    this.dataForm.isRecommend = response.data.isRecommend === '1'
                    this.dataForm.floorNum = response.data.floorNum
                    this.dataForm.zoneNum = response.data.zoneNum
                    this.dataForm.positionNum = response.data.positionNum
                    this.dataForm.locationRemark = response.data.locationRemark
                    this.dataForm.shopBanner = response.data.shopBanner !== null ? response.data.shopBanner : imageBack
                    this.isShowBannerImg = response.data.shopBanner !== null
                    this.dataForm.shopBackround = response.data.bgImg !== null && response.data.bgImg !== '' ? response.data.bgImg : imageBack
                    this.isShowShopBackgroundImg = response.data.bgImg !== null && response.data.bgImg !== ''
                    this.dataForm.openDt = response.data.openDt !== '' ? this.$moment(response.data.openDt).format('YYYY-MM-DD') : ''
                    this.dataForm.shopLicense = response.data.shopLicense !== '' ? response.data.shopLicense : imageBack
                    this.isShowLicenseImg = response.data.shopLicense !== ''
                    this.dataForm.ownerAvatar = response.data.ownerAvatar !== '' ? response.data.ownerAvatar : imageBack
                    this.isShowOwnerImg = response.data.ownerAvatar !== ''
                    this.dataForm.payCode = response.data.payCode !== '' ? response.data.payCode : imageBack
                    this.isShowPayCodeImg = response.data.payCode !== ''
                    this.dataForm.bankCard = response.data.bankCard
                    this.dataForm.shopIntro = response.data.shopIntro
                    this.dataForm.offCause = response.data.offCause

                    if (response.data.tags !== null) {
                        if (response.data.tags.length !== 0) {
                            let name = ''
                            response.data.tags.filter(res => {
                    ...
                    this.setChangeFloor(response.data.zoneNum, response.data.positionNum)
                    this.setChangeZone(response.data.positionNum)
                }
            })
        },
        ...
        setChangeFloor(val1, val2) { // 점포층에 따르는 점포구역 얻기
            this.listZone = []
            this.listPosition = []
            this.dataForm.zoneNum = val1
            this.dataForm.positionNum = val2
        ...
        setChangeZone(value) { // 점포구역에 따르는 점포위치 얻기
            this.listPosition = []
            this.dataForm.positionNum = value
        ...
        getOwnerInfoData() { // 운영자위챗정보 얻기
            ...
            getWechatInfo(query).then(response => {
                if (response.code === 0) {
                    ...
                    if (response.data.list.length !== 0) {
                        response.data.list.filter(res => {
                            if (res.id === this.dataForm.shopWechatId) {
                                this.dataForm.shopWechatName = res.userNick
                            }
        ...
        async setUpdate() { // 점포등록
            ...
            if (this.dataForm.shopBannerFile !== undefined) {
                ...
                const isCheck = await this.compareImageName(this.dataForm.shopBanner)
                bannerUri = isCheck === true ? '' : this.dataForm.shopBanner.split('/')[4]
            }
            ...
            if (this.dataForm.shopBackroundFile !== undefined) {
                ...
                const isCheck = await this.compareImageName(this.dataForm.shopBackround)
                shopBackroundUri = isCheck === true ? '' : this.dataForm.shopBackround.split('/')[4]
            }
            ...
            if (this.dataForm.shopLicenseFile !== undefined) {
                ...
                const isCheck = await this.compareImageName(this.dataForm.shopLicense)
                licenseUri = isCheck === true ? '' : this.dataForm.shopLicense.split('/')[4]
            }
            ...
            if (this.dataForm.payCodeFile !== undefined) {
                ...
                const isCheck = await this.compareImageName(this.dataForm.payCode)
                payCodeUri = isCheck === true ? '' : this.dataForm.payCode.split('/')[4]
            }
            ...
            if (this.dataForm.ownerAvatarFile !== undefined) {
                ...
                const isCheck = await this.compareImageName(this.dataForm.ownerAvatar)
                ownerUri = isCheck === true ? '' : this.dataForm.ownerAvatar.split('/')[4]
            }
            ...
            const query = {
                ...
                offCause: this.dataForm.offCause
            }

            setUpdateShop(this.shopId, query).then(response => {
                if (response === '') {
        ...
        async setShopHidden() {
            const isSuccess = await this.openMessageBox('确认要商户删除吗？')

            if (!isSuccess) {
                return
            }

            setShopHidden(this.shopId).then(response => {
                if (response === '') {
                    showToast(this, '操作成功', 'success')
